...
var cartaFlash = {
  nome: "Flash",
  imagem: "https://i.egycdn.com/pic/WmFwZndlY21UWWp2TnZtdWNsdk5tbW5JUHZjY3c.jpg",
  atributos: {
  Ataque: 80, Defesa: 70, 
  Magia: 100,
  }
...
var cartaGoku = {
  nome: "Goku",
  imagem:"https://observatoriodocinema.uol.com.br/wp-content/uploads/2020/04/Dragon-Ball.jpg",
  atributos: { 
  Ataque: 90,
  Defesa: 90,
  Velocidade: 75,
  Magia: 80,
  //considerando em "magia", o "KI" de Dragon Ball.
 }
}
...
imagem:"https://i.pinimg.com/originals/6e/f4/a0/6ef4a0644be99e116513f24f3f9ab340.jpg",
  atributos: {
   Ataque: 75,                                    
   Defesa: 70,                                     
   Velocidade: 50,                              
...
var cartaSuperTrunfo = {
  nome: "Tio do Lámen",
  imagem: "https://pm1.narvii.com/6367/4908dce28d82101bfa92724982827845bf4995f0_hq.jpg",
  atributos: {
  ataque: 100,
  defesa: 100,
  magia: 100, 
...
var cartaMaquina
var cartaJogador
var cartas = [cartaPaulo, cartaRafa, cartaGui, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel , cartaFlash, cartaGoku, cartaGeralt, cartaSuperTrunfo]
//            0           1           2          3         4            5            6           7     
...
atualizarPlacar()
atualizarQntDeCartas()

function atualizarQntDeCartas() {
...
function exibeCartaJogador() {
    ...
    var moldura = '<img src="https://i.pinimg.com/originals/4c/ff/eb/4cffeb1820b660e6d771dd9511244bb0.png" style=" width: inherit; height: inherit; position: absolute;">';
